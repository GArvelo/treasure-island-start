...
if road == "Left" or "left":
  ...
  if water == "Wait" or "wait":
    door = input("You arrive at the island unharmed. There is a house with 3 door. One red, one yellow and one blue. Which color do you choose?\n" )
    if door == "yellow":
